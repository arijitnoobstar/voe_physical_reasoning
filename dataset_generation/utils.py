...
generate_depth_videos = False
generate_instance_frames = False
generate_instance_videos = True
# PATH TO DATASET (where the 5 directories of AVoE are present)
root_path = 'C:/Users/DJ Myylo/Desktop/I2R Internship/AVoE-main/AVoE_dataset_generation/Data/'
#-----------------------------------#

# event_categories = ['A_support', 'B_occlusion', 'C_container', 'D_collision', 'E_barrier']
event_categories = ['A_support']
# trial_num_indices = [range(1,376), range(1,376), range(3751,3826), range(3751,3826), range(4501,4551), range(4501,4551)]
# segments = ['train/expected/', 'train/surprising/', 'validation/expected/', 'validation/surprising/', 'test/expected/', 'test/surprising/']
